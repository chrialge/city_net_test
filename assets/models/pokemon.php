...
class Utenti
{
    ...
    public function save($connection)
    {
        ...
        $stmt->bind_param("ssssssssssssss", $this->numeroPokedex, $this->nome, $this->descrizione, $this->baseStrenght, $this->massimoStrenght, $this->baseDexterity, $this->massimoDexterity, $this->baseVitality, $this->massimoVitality, $this->baseSpecial, $this->massimoSpecial, $this->baseInsight, $this->massimoInsight, $this->hp, $this->idRango);
